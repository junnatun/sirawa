...
$ambildata = mysqli_query($conn, "SELECT * FROM tb_guru JOIN tb_mapel USING(id_guru) JOIN tb_user USING(id_user) WHERE id_user = '$id_user'");
                                    ...
                                    <div class="card-body">
                                        <table class="table table-borderless" id="table1">
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td><?=$result['mapel'];?> ( <?=$result['id_mapel'];?> )</td>
                                            </tr>
                                        </table>
                                        <div class="alert alert-light-danger">
                                            <i class="bi bi-exclamation-circle"></i>
                                            Apabila terdapat kesalahan data diri, silahkan menghubungi admin Sirawa. 
                                        </div>
                                    </div>
                                </div>
                            </div>
